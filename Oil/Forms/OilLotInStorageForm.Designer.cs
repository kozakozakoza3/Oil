namespace Oil
{
    partial class OilLotInStorageForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTitle.Location = new Point(160, 24);
            ...
            lblInfo.Location = new Point(100, 88);
            lblInfo.Name = "lblInfo";
            lblInfo.Size = new Size(600, 24);
            lblInfo.TabIndex = 1;
            lblInfo.Text = "Список партий нефти, находящихся в резервуарах на складе";
            // 
            // dgvOilLots
            // 
